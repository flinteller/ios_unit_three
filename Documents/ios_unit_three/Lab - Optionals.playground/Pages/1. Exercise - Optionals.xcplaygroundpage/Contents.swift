...
print(userAge)
print("We get an error that says it can't convert type string to int, it can't turn 'e' into and int")
 ...
 */
print("The question mark prints nil if the string con't be converted")
